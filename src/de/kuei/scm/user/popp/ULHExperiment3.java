 ...
 *
 */
public class ULHExperiment3 {
	
	public static void main(String[] args) throws Exception {
		StaticDynamicUncertaintyULHSolver solver = new StaticDynamicUncertaintyULHSolver();
		
		PrintStream filePrintStream = new PrintStream(new File("results/ULHExperiment3.csv"));
		...
		out.println("alpha;Simulation-Gap;Blocked-Overshoot-Gap;Simulation-Gap;Blocked-Overshoot-Gap;Simulation-Gap;Blocked-Overshoot-Gap;Simulation-Gap;Blocked-Overshoot-Gap;Simulation-Gap;Blocked-Overshoot-Gap;Simulation-Gap;Blocked-Overshoot-Gap;Simulation-Gap;Blocked-Overshoot-Gap;Simulation-Gap;Blocked-Overshoot-Gap;Simulation-Gap;Blocked-Overshoot-Gap;");
		...
		DecimalFormat oneDecimal = new DecimalFormat("0.00", new DecimalFormatSymbols(Locale.US));
		int n = 10000;
		...
		EqualDivisionNormalDistributedOrdersGenerator orderGenerator = new EqualDivisionNormalDistributedOrdersGenerator(0, 0);
		
		for(float alpha = .8f; alpha  < 1; alpha += .01){
			out.print(oneDecimal.format(alpha));

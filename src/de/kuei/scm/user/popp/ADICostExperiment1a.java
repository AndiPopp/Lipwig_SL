 ...
 *
 */
public class ADICostExperiment1a {
	
	public static void main(String[] args) throws Exception {
		StaticDynamicUncertaintyWithADIULHSolver solver = new StaticDynamicUncertaintyWithADIULHSolver();
		
		PrintStream filePrintStream = new PrintStream(new File("results/ADI-Cost-Experiment1a.csv"));
		...
		for(int l = 1; l < 21; l++){
			...
			EqualDivisionNormalDistributedOrdersGenerator orderGenerator = new EqualDivisionNormalDistributedOrdersGenerator(l-1, 0);

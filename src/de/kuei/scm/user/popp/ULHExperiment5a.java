 ...
 *
 */
public class ULHExperiment5a {
	
	public static void main(String[] args) throws Exception {
		StaticDynamicUncertaintyWithADIULHSolver solver = new StaticDynamicUncertaintyWithADIULHSolver();
		
		PrintStream filePrintStream = new PrintStream(new File("results/ULHExperiment5a.csv"));
		...
		out.println("s;Simulation-Gap;Blocked-Overshoot-Gap;Simulation-Gap;Blocked-Overshoot-Gap;Simulation-Gap;Blocked-Overshoot-Gap;Simulation-Gap;Blocked-Overshoot-Gap;Simulation-Gap;Blocked-Overshoot-Gap;Simulation-Gap;Blocked-Overshoot-Gap;Simulation-Gap;Blocked-Overshoot-Gap;Simulation-Gap;Blocked-Overshoot-Gap;Simulation-Gap;Blocked-Overshoot-Gap;");
		...
		DecimalFormat oneDecimal = new DecimalFormat("00000.0", new DecimalFormatSymbols(Locale.US));
		int n = 10000;
		...
		double cv = 1.0;
		float alpha = .95f;
		EqualDivisionNormalDistributedOrdersGenerator orderGenerator = new EqualDivisionNormalDistributedOrdersGenerator(7, 0);
		
		for(double setupCost = 100; setupCost  < 26000; setupCost *= 2){
